            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li id="dashboard"><a class="nav-link" href="<?= base_url('Driver'); ?>"><i class="fas fa-fire"></i><span>General Dashboard</span></a></li>
                        <!-- End of Dashboard -->

                        <!-- End Transaksi -->
                        <li class="menu-header">End Transaction</li>
                        <li id="end-transaction"><a class="nav-link" href="<?= base_url('Driver/endTransaction'); ?>"><i class="fas fa-cube"></i><span>End Transaction</span></a></li>
                        <!-- End of Dashboard -->
                    ...
                    <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                        <a href="#" class="btn btn-warning btn-lg btn-block btn-icon-split" readonly>
                            <i class="fas fa-rocket"></i> Driver
                        </a>
                    </div>
                    <!-- End of Footer -->
                </aside>
